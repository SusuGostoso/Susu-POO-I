...
class DataService {
  ...
  //Cervejas: https://random-data-api.com/api/beer/random_beer?size=5
  //Cafés: https://random-data-api.com/api/coffee/random_coffee?size=5
  //Nações: https://random-data-api.com/api/nation/random_nation?size=5
